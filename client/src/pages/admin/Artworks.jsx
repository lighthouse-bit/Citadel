// client/src/pages/admin/Artworks.jsx
...
const Artworks = () => {
  ...
  const handleBulkDelete = () => {
    setArtworks(prev => prev.filter(a => !selectedArtworks.includes(a.id)));
    toast.success(`${selectedArtworks.length} artworks deleted`);
    setSelectedArtworks([]);
  };
      ...
      <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-4">
        ...
        {selectedArtworks.length > 0 && (
          <motion.div
            ...
            className="mt-4 pt-4 border-t border-stone-200 flex items-center gap-4"
          >
