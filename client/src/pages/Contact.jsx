                  ...
                  <div className="flex gap-4">
                    {settings.socialInstagram && (
                      <a
                        ...
                        className="w-12 h-12 border border-stone-300 rounded-full
                                   flex items-center justify-center text-stone-600
                                   hover:text-amber-700 hover:border-amber-500 transition-colors"
                      >
                        <Instagram size={20} />
                      </a>
                    )}
                ...
                <div className="mt-8 p-6 bg-stone-100 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`w-3 h-3 rounded-full ${
                      settings.commissionOpen ? 'bg-green-500' : 'bg-red-500'
                    }`} />
