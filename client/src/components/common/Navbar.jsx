          ...
          <div className="hidden md:flex items-center z-50">
            ...
            <div className="flex items-center space-x-2 border-l pl-6 border-white/20">
              ...
              <button
                ...
                className={`relative group p-2 focus:outline-none transition-colors 
                            duration-300 ${getTextColor()} ${getHoverColor()}`}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-0 left-0 w-full bg-white shadow-xl md:hidden 
                       border-b border-stone-200 z-40"
          >
            <div className="pt-24 pb-8 px-6 space-y-6 flex flex-col items-center text-center">

              {/* ✅ Mobile logo */}
              <p className="text-xs text-amber-700 tracking-widest uppercase">
                  ...
                  <div className="relative">
                    ...
                    {cartItems.length > 0 && (
                      <span className="absolute -top-1 -right-1 w-3 h-3 
                                       bg-amber-600 rounded-full border border-white" />
                    )}
                  </div>
